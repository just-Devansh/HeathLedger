...
const DARK_BASE = {
  ...
  textMuted: '#9399b2',
  textFaint: '#585b70',
  glassBg: 'rgba(24,24,37,0.92)',
  glassShadow: '0 10px 30px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.06)',
  filterBg: 'rgba(30,30,46,0.90)',
...
const ACCENT_VARIANTS = {
  ...
  black: {
    ...
    dark: {
      ...
      secondary: '#1e293b',
      gradEnd: '#475569',
      gradientBg: 'linear-gradient(135deg, #1e293b, #334155, #475569)',
      mutedText: '#94a3b8',
      heading: '#f1f5f9',
      shadowRgb: '51,65,85',
    },
